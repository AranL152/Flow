    ...
    private var content: some View {
        ...
        case .welcome:
            VStack(alignment: .leading, spacing: FW.spacing12) {
                Text("FlowWhispr turns quick dictation into clean text, fast.")
                    .font(.subheadline)
        ...
        case .accessibility:
            VStack(alignment: .leading, spacing: FW.spacing16) {
                Text("To listen for your hotkey, FlowWhispr needs Accessibility access. You control this anytime in System Settings.")
                    .font(.subheadline)
                    .foregroundStyle(FW.textSecondary)
        ...
        case .hotkey:
            VStack(alignment: .leading, spacing: FW.spacing16) {
                Text("Choose a hotkey for starting and stopping recording.")
                    .font(.subheadline)
                    .foregroundStyle(FW.textSecondary)
